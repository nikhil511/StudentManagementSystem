...
public class Student {
	...
	private boolean validateStudentId(String studentId) {
		...
		if (studentIdMatcher.matches()) {
			...
			System.err.println("Invalid student Id...Use the format Id Eg.S-123");
		}
		return false;
	}
	...
	public boolean validateCourseName(String course) {
		if (course.equalsIgnoreCase("Java") || course.equalsIgnoreCase("DSA") || course.equalsIgnoreCase("DevOps")) {
			...
			System.err.println("Invalid Course name!!! Please select course name from the list [Java,DSA,DevOps]");
			return false;
		}
